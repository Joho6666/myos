...
These images are safe, non-sensitive product assets for the MyOS repository and release page.

| File | Use |
| --- | --- |
| `myos-icon.png` | Windows application and release icon |
| `login.png` | Login screen preview |
